...
function (_Component) {
  ...
  _createClass(SplitterPannelItem, [{
    ...
    value: function render() {
      ...
      }, this.state.move && React__default.createElement("div", {
        className: "cover"
      }), React__default.cloneElement(children, {
        open: this.open
      }), this.state.index !== 0 && React__default.createElement(Hammer, {
  ...
  _createClass(SplitterPannel, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        return React__default.createElement(SplitterPannelItem, _extends({
          key: item.id
        }, item, item.props, {
  ...
  _createClass(PropertyPanel, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        className: "icon-btn",
        onClick: this.toggle
      }), children.length > 0 && React__default.createElement(_Tabs, {
        onChange: this.onChange,
        type: "card",
        activeKey: activeKey,
...
exports.SplitterPannel = SplitterPannel;
